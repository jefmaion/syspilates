            ...
            <div class="card flex-fill">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a href="#tab-instructor-modality" wire:click.prevent="tabs('tab-instructor-modality')" class="nav-link {{ $tab === 'tab-instructor-modality' ? 'active' : '' }}" data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1">
                                Modalidades
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a href="#tab-class-history" wire:click.prevent="tabs('tab-class-history')" class="nav-link {{ $tab === 'tab-class-history' ? 'active' : '' }}" data-bs-toggle="tab" aria-selected="true" role="tab">
                                Histórico de Aulas
                            </a>
                        </li>

                        <li class="nav-item" role="presentation">
                            <a href="#tab-payments" wire:click.prevent="tabs('tab-payments')" class="nav-link {{ $tab === 'tab-payments' ? 'active' : '' }}" data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1">
                                Financeiro
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a href="#tab-userdata" wire:click.prevent="tabs('tab-userdata')" class="nav-link {{ $tab === 'tab-userdata' ? 'active' : '' }}" data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1">
                                Dados Cadastrais
                            </a>
                        </li>

                        <li class="nav-item" role="presentation">
                            <a href="#tab-access" wire:click.prevent="tabs('tab-access')" class="nav-link {{ $tab === 'tab-access' ? 'active' : '' }}" data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1">
                                Acesso ao sistema
                            </a>
                        </li>
                    </ul>
                ...
                <div class="csard-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane {{ $tab === 'tab-instructor-modality' ? 'active show' : '' }}" id="tab-instructor-modality" role="tabpanel">
                            <div>
                                ...
                                <x-table.table :search="false">
                                    ...
                                    @foreach ($instructor->modalities as $modality)
                                        <tr>
                                            ...
                                            <td>
                                                <x-buttons.button-link href="#" wire:click="$dispatch('edit-modality', {modalityId: {{ $modality->id }}})" class="btn-warning btn-sm">
                                                    <x-icons.edit class="" /><span class="d-none d-sm-inline">Editar</span>
                                                </x-buttons.button-link>

                                                <x-buttons.button-link wire:click="$dispatch('remove-modality', {modalityId: {{ $modality->id }}})" class="btn-danger bgst btn-sm">
                        ...
                        <div class="tab-pane {{ $tab === 'tab-userdata' ? 'active show' : '' }}" id="tab-userdata" role="tabpanel">
                            <div>
                                <livewire:instructor.instructor-form :modal="false" :instructor="$instructor" />
                            </div>
                        </div>
                        <div class="tab-pane {{ $tab === 'tab-access' ? 'active show' : '' }}" id="tab-access" role="tabpanel">
                            <div class="mb-3">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="divide-y">
