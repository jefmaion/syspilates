<div class="@if($modal) modal-body @endif">
    <div class="row">
...
<div class="@if($modal) modal-body @endif">
    <div class="row ">
        <div class="col-md-3 col-lg-3 col-xl-3 mb-3">
            ...
            <input type="number" class="form-control @error('user.zipcode') is-invalid @enderror"
                wire:model="user.zipcode" wire:blur.lazy="getAddress" />
        </div>
