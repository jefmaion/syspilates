                ...
                <tr class="align-middle">
                    ...
                    <td class="text-end">
                        <div class="btn-list flex-nowrap">
                            <x-buttons.button-link href="#" wire:click="$dispatch('edit-student', { student: {{ $item->id }} })"  class="btn-wsarning bg-orange-lt btn-sm">
                                <x-icons.edit class="" /><span class="d-none d-sm-inline">Editar</span>
                            </x-buttons.button-link>

                            <x-buttons.button-link
                                wire:click="$dispatch('delete-student', { student: {{ $item->id  }} })"
