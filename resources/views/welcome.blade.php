                ...
                <div class="page-header d-print-none">
                    <div class="row g-2 align-items-center">
                        <div class="col">
                            ...
                            <h2 class="page-title">Laravel Tabler</h2>
                        </div>
                    </div>
                </div>
                <!-- END PAGE HEADER -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-auto d-flex">
                                            <svg class="me-3" width="32" xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24">
                                                <path fill="#FF2D20"
                                        ...
                                        <div class="col">
                                            <div>
                                                ...
                                                <span class="text-secondary text-sm">
                                                    ...
                                                    all of the
                                                    latest and most important news in the Laravel ecosystem, including
                                                    new package
